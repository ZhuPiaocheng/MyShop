			...
			<div class="topnav_right fr">
				<ul>
					<!--<li>
                                            ...
                                            <?php else: ?>
                                            您好！欢迎来到手机商场！[<a href="<?php echo U('Member/login');?>">登录</a>] [<a href="<?php echo U('Member/regist');?>">免费注册</a>] </li>
                                            <?php endif;?>-->
                                        <li id = "logInfo"></li>
					<li class="line">|</li>
...
<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
                    <h1 class="fl"><a href="<?php echo U('Index/index');?>"><img src=" " alt="手机商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div id="search_condition">
				...
				<?php  $brandId = I('get.brand_id'); if($brandId): ?>
					<span>
						品牌：<?php echo ltrim(strstr($brandId, '-'), '-'); ?>
                                                <a href="<?php echo fliterURL('brand_id');?>">X</a>
					</span>
				<?php endif; ?>
				...
				<?php  $price = I('get.price'); if($price): ?>
					<span>
						价格：<?php echo $price; ?>
						<a href="<?php echo fliterURL('price');?>">X</a>
					</span>
				<?php endif; ?>
				...
				<?php  foreach ($_GET as $k => $v): if(strpos($k, 'attr_') === 0) : $_attrName = strrchr($v, '-'); ?>
					<span>
						...
						<a href="<?php echo fliterURL($k);?>">X</a>
					</span>
			...
			<div class="sort mt10">
				<dl>
					<dt>排序：</dt>
					<dd <?php if($odby=='xl') echo 'class="cur"'; ?>><a href="">销量</a></dd>
					...
					<!--<dd><a href="">评论数</a></dd>-->
					<dd <?php if($odby=='addtime') echo 'class="cur"'; ?>><a href="">上架时间</a></dd>
				</dl>
			</div>
			<!-- 排序 end -->
...
$.ajax({
	...
	success : function(data)
	{
		if(data.login == 1)
			...
			var li = '您好，欢迎来到手机商场！[<a href="<?php echo U('Member/login'); ?>">登录</a>] [<a href="<?php echo U('Member/regist'); ?>">免费注册</a>]'
		$("#logInfo").html(li);
	}
});
</script>