...
<head>
	...
	<!-- 引入公共的CSS -->
	<link rel="stylesheet" href="/www.39.com/Public/Home/style/base.css" type="text/css">
	<link rel="stylesheet" href="/www.39.com/Public/Home/style/global.css" type="text/css">
	<link rel="stylesheet" href="/www.39.com/Public/Home/style/header.css" type="text/css">
	<link rel="stylesheet" href="/www.39.com/Public/Home/style/bottomnav.css" type="text/css">
	<link rel="stylesheet" href="/www.39.com/Public/Home/style/footer.css" type="text/css">
	<!-- 引入公共的JS -->
	<script type="text/javascript" src="/www.39.com/Public/Home/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/www.39.com/Public/Home/js/header.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<!--<li>
                                            <?php if(session('m_id')):?>
                                            您好，<?php echo session('m_username');?>[<a href="<?php echo U('Member/lougout');?>">退出</a>]
                                            <?php else: ?>
...
<link rel="stylesheet" href="/www.39.com/Public/Home/style/home.css" type="text/css">
<link rel="stylesheet" href="/www.39.com/Public/Home/style/order.css" type="text/css">
<script type="text/javascript" src="/www.39.com/Public/Home/js/home.js"></script>

<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		<!-- 头部上半部分 start 包括 logo、搜索、用户中心和购物车结算 -->
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="/www.39.com/Public/Home/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				...
				<dl>
					...
					<dd>
						...
						<div class="viewlist mt10">
							<h3>最近浏览的商品：</h3>
							<ul>
								<li><a href=""><img src="/www.39.com/Public/Home/images/view_list1.jpg" alt="" /></a></li>
								<li><a href=""><img src="/www.39.com/Public/Home/images/view_list2.jpg" alt="" /></a></li>
								<li><a href=""><img src="/www.39.com/Public/Home/images/view_list3.jpg" alt="" /></a></li>
							</ul>
						</div>
					</dd>
				</dl>
				...
				<dl>
					...
					<dd>
						<div class="prompt" id ="cart_div_list">
                                                    <img src="/www.39.com/Public/Home/images/loading.gif" />
						</div>
					</dd>
				</dl>
			</div>
...
$("#cart_list").mouseover(function(){
	...
	<div class="footer w1210 bc mt15">
		...
		<p class="auth">
			<a href=""><img src="/www.39.com/Public/Home/images/xin.png" alt="" /></a>
			<a href=""><img src="/www.39.com/Public/Home/images/kexin.jpg" alt="" /></a>
			<a href=""><img src="/www.39.com/Public/Home/images/police.jpg" alt="" /></a>
			<a href=""><img src="/www.39.com/Public/Home/images/beian.gif" alt="" /></a>
		</p>
	</div>
	<!-- 底部版权 end -->
