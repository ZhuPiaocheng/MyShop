...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form action="/www.39.com/index.php/Admin/Goods/add.html" method="post" enctype="multipart/form-data">
            <!--通用信息-->
            <table width="90%"  class = "tab_table" align="center">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        促销价格 ￥<input type="text" name="promote_price" size="8"/>元<br />
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="is_best" value="是" checked="checked" /> 是
