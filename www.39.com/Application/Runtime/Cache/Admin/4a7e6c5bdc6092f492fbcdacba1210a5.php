...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form action="/www.39.com/index.php/Admin/Goods/test1" method="post" enctype="multipart/form-data">
            ...
            <table width="90%"  class="tab_table" align="center">
                ...
                <tr>
                    <td class="label">LOGO</td>
                       <td>
                          <img src = "/www.39.com/Public/Uploads/<?php echo $data['sm_logo']; ?>"/><br />
                ...
                <tr>
                    ...
                    <td>
                        促销价格 ￥<input type="text" name="promote_price" size="8" value="<?php echo $data['promote_price'];?>"/>元<br />
                        开始时间<input type="text" name="promote_start_date" id="promote_start_date" value="<?php echo $data['promote_start_date'];?>"/>
                        结束时间<input type="text" name="promote_end_date" id="promote_end_date" value="<?php echo $data['promote_start_date'];?>"/>
                    </td>
                </tr>
                <tr>
            ...
            <!--商品会员价格-->
            <table width="90%" style="display:none;" width="90%" class="tab_table" align="center">
                <tr>
                    <td>
    ...
    <link href="/www.39.com/Public/umeditor1_2_2-utf8-php/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="/www.39.com/Public/umeditor1_2_2-utf8-php/third-party/jquery.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="/www.39.com/Public/umeditor1_2_2-utf8-php/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/www.39.com/Public/umeditor1_2_2-utf8-php/umeditor.min.js"></script>
    <script type="text/javascript" src="/www.39.com/Public/umeditor1_2_2-utf8-php/lang/zh-cn/zh-cn.js"></script>
    <script>
