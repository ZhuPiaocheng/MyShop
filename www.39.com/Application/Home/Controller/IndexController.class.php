...
class IndexController extends NavController {
    ...
    public function displayHistory1()
    {
        ...
        $goodsModel = D('Goods');
        $data = implode(',', $data);
        $gData = $goodsModel ->field('id,mid_logo,good_name')->where(array(
            'id'=>array('in',$data),
